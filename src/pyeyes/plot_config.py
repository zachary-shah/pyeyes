...
class PlotConfig:
    ...
    plot_trim: list = field(default_factory=lambda: [5, 0]) # trim x, y by this many pixels on each side
    fov_shift: list = field(default_factory=lambda: [0, 0]) # cyclic shift x, y by this many pixels
